...
public class MLSRuleDialog extends JDialog implements ActionListener
{
    ...
    public MLSRuleDialog(JFrame frame, boolean modal, String dialogType, DefaultMutableTreeNode node)
    {
        super(frame, modal);
        ...
        border = BorderFactory.createTitledBorder("Rule Property Addition");
