...
public class ModelPropertiesPanel extends JPanel
{
    ...
    public ModelPropertiesPanel(ACPTFrame frame, JTree modelTree, ModelInfo modelInfo, boolean editable)
    {
    ...
    private void setPanels(ModelInfo targetInfo)
    {
        ...
        this.add(Box.createRigidArea(new Dimension(80 + 15, GraphicsUtil.FIELD_HEIGHT)));
    ...
    public void updateTargetValue(String value)
    {
        ...
        if (modelInfo.getModelType().equals(ModelInfo.ROOT))
        {
    ...
    class ModelPropertiesPanelActionAdapter implements ActionListener
    {
        ...
        ModelPropertiesPanel modelPropertiesPanel = null;

        ModelPropertiesPanelActionAdapter(ModelPropertiesPanel modelPropertiesPanel)
        {

            this.modelPropertiesPanel = modelPropertiesPanel;
