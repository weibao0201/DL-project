...
public class WORKFLOWPanel extends JPanel
{
    ...
    /* Adapters */
    public WorkFlowPanelActionAdapter userPanelActionAdapter = null;

    /***************************************************************************
     * Constructors
     **************************************************************************/

    public WORKFLOWPanel(ACPTFrame frame, JTree modelTree, ModelInfo modelInfo, boolean editable)
    {
    ...
    private void setAdapters()
    {
        ...
        this.userPanelActionAdapter = new WorkFlowPanelActionAdapter(this);
    ...
    private void setPanels(ModelInfo modelInfo)
    {
        ...
        /*
         * JPanel PolComPanel = new JPanel(); titledBorder =
         * BorderFactory.createTitledBorder("Rule Combination Algorithm");
         ...
         *
         * PolComPanel.add(algLabel); PolComPanel.add(Box.createRigidArea(new
         * Dimension(15,GraphicsUtil.FIELD_HEIGHT)));
         *
         * PolComPanel.add(ComboBox); PolComPanel.add(Box.createRigidArea(new
         * Dimension(15,GraphicsUtil.FIELD_HEIGHT)));
         *
        ...
        if (modelTree != null)
        {
            List<DefaultMutableTreeNode> choices = ModelTreeUtil.getTargetTreeChildrenNode2List(
                    ModelTreeUtil.getCurrentNode(modelTree), ModelInfo.WORKFLOWRule, ModelInfo.NodeLevelofruleroot);
        ...
        /*
         * This makes it so that if a rule was added by Inheritance then it will
         * not show up in the panel.
         */
        String hold_num = "";
        if (modelTree != null)
        {
             ...
             * before Inheritance was added. If it was, it addes a rule number
             * to each rule.
             */
            if (choices.size() > 0)
            {
        ...
        titledBorder = BorderFactory.createTitledBorder("Workflow Policy");
    ...
    public void updateRuleElmChildNode(String type, JList selectedlist, DefaultListModel selectedlistmodel)
    {
        ...
        if (selectedlist.getSelectedIndex() >= 0)
        {
            ...
            RuleDialog myDialog =
                    new RuleDialog(frame, true, ModelInfo.WORKFLOWRule, targetTree, "", "Update", currentNode, holdNum);
            ...
            if (myDialog.getAnswer())
            {
                ...
                List nodes = ModelTreeUtil.getTargetTreeChildrenNode2List(parentNode, ModelInfo.WORKFLOWRule, 4);
                ...
                currentNode =
                        ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule, TargetAttrValue, modelTree, false);
                ...
                for (int i = 0; i < myDialog.getcountSubject(); i++)
                {
                    ...
                    for (int j = 0; j < inheritance.size(); j++)
                    {
                                        ...
                                        .getvalueOfvalue()))
                        {
                            ...
                            if (newRuleValue != "")
                            {
                                currentNode = ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule, newRuleValue,
                                        modelTree, true);
                            ...
                            while (newrule)
                            {
                                ...
                                for (int x = 0; x < inheritance.size(); x++)
                                {
                                                    ...
                                                    .getvalueOfvalue()))
                                    {
                                        ...
                                        if (newRuleValue != "")
                                        {
                                            currentNode = ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule,
     ...
     * @since 1.6
     */
    class WorkFlowPanelActionAdapter implements ActionListener
    {

        WORKFLOWPanel userPanel = null;

        WorkFlowPanelActionAdapter(WORKFLOWPanel userPanel)
        {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (e.getActionCommand().equals("Update"))
            {
                ...
                updateRuleElmChildNode(ModelInfo.WORKFLOWRule, list, listmodel);
                ...
                if (modelTree != null)
                {
                    List<DefaultMutableTreeNode> choices =
                            ModelTreeUtil.getTargetTreeChildrenNode2List(ModelTreeUtil.getCurrentNode(modelTree),
                                    ModelInfo.WORKFLOWRule, ModelInfo.NodeLevelofruleroot);
                    DefaultMutableTreeNode RuleCombinationNode = choices.get(0);

                    RuleCombinationNode.setUserObject(
                            new ModelInfo(ModelInfo.WORKFLOWRule, "Rules: " + ComboBox.getSelectedItem().toString()));
            ...
            else if (e.getActionCommand().equals("Add"))
            {
                ...
                RuleDialog myDialog =
                        new RuleDialog(frame, true, ModelInfo.WORKFLOWRule, targetTree, "", "Add", null, ruleNum);
                ...
                if (myDialog.getAnswer())
                {
                    ...
                    DefaultMutableTreeNode newNode =
                            ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule, ruleValue, modelTree, false);
                    // add condition node
                    ...
                    for (int i = 0; i < myDialog.getcountSubject(); i++)
                    {
                        ...
                        for (int j = 0; j < inheritance.size(); j++)
                        {
                                            ...
                                            .getvalueOfvalue()))
                            {
                                ...
                                DefaultMutableTreeNode subjectNode = TargetTreeUtil.getFirstMatchingNode(targetTree,
                                        holdToV, TargetInfo.SUBJECT_ATTRIBUTES, 2);
                                // subjectNode = (DefaultMutableTreeNode)
                                ...
                                if (newRuleValue != "")
                                {
                                    newNode = ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule, newRuleValue,
                                            modelTree, true);
                                ...
                                while (newrule)
                                {
                                    ...
                                    for (int x = 0; x < inheritance.size(); x++)
                                    {
                                                        ...
                                                        .getUserObject()).getvalueOfvalue()))
                                        {
                                            ...
                                            if (newRuleValue != "")
                                            {
                                                newNode = ModelTreeUtil.addGrandChildNode(ModelInfo.WORKFLOWRule,
                                                        newRuleValue, modelTree, true);
