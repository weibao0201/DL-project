...
public class MULTILEVELResourceLevelsPanel extends JPanel
{
    ...
    /* Adapters */
    public MultiLevelResourceLevelPanelActionAdapter userPanelActionAdapter = null;

    /***************************************************************************
     * Constructors
     **************************************************************************/

    public MULTILEVELResourceLevelsPanel(ACPTFrame frame, JTree modelTree, ModelInfo modelInfo, boolean editable)
    {
    ...
    private void setAdapters()
    {
        ...
        this.userPanelActionAdapter = new MultiLevelResourceLevelPanelActionAdapter(this);
    ...
    public String getRuleValue()
    {
        ...
        if ((resourceComboBox.getSelectedItem() == null) || (levelComboBox.getSelectedItem() == null))
        {
     ...
     * @since 1.6
     */
    class MultiLevelResourceLevelPanelActionAdapter implements ActionListener
    {

        MULTILEVELResourceLevelsPanel userPanel = null;

        MultiLevelResourceLevelPanelActionAdapter(MULTILEVELResourceLevelsPanel userPanel)
        {
